const copyEntries = {
  ...
  'auth.login.subtitle': 'Track your daily Word scores',
  ...
  'auth.signup.subtitle': 'Join Word Tournaments',
  ...
  'dailySubmission.dbInvalidGridError': 'Invalid Word grid. Please paste the complete result including the emoji rows.',
  'dailySubmission.dbSaveFallbackError': 'Unable to save submission',
  'dailySubmission.emptySubmissionError': 'Please paste your result for today\'s Word Game',
  'dailySubmission.formTitle': 'Daily Word Game Submission',
  'dailySubmission.instruction1': '1. Play today\'s Word Game',
  ...
  'dailySubmission.introModal.submitStep1': '1. Play today\'s NYT Word Game',
  ...
  'dailySubmission.introModal.title': 'Welcome to Word Game Battle',
  'dailySubmission.invalidGridError': 'Invalid Word Game grid. Please paste the complete result including the emoji rows.',
  'dailySubmission.nextSubmissionInfo': 'Come back tomorrow for your next submission!',
  'dailySubmission.openInputPlaceholder': 'Paste your Word Game result here...',
  'dailySubmission.parseFailedError': 'Something went wrong parsing your result. Please try pasting it again.',
  ...
  'stats.submissionsSubtext': 'Word Games completed',
